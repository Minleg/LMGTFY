...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var searchConfirmationTextView: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchConfirmationTextView = findViewById(R.id.show_search_text)
    ...
    private fun echoUserSearchTerm() {
        val text = searchText.text
        if (text.isNotBlank()) {
            searchConfirmationTextView.text = getString(R.string.search_display_text, text)
        } else {
            searchConfirmationTextView.text = getString(R.string.search_display_text, "...")
        }
    }
}
